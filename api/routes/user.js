...
router.put("/update-user", authMiddleware, asyncHandler(userController.updateUserInfo));
router.get("/me", authMiddleware, asyncHandler(userController.getUserDetails));
router.get("/get-clients", authMiddleware, asyncHandler(userController.getClients));
...
router.put("/add-domain", authMiddleware, asyncHandler(userController.createDomainName));
// router.get(
//   "/list-players",
//   authMiddleware,
...
router.post("/subscribe", authMiddleware, asyncHandler(userController.subscribeToPlan));
router.post(
...
router.get("/all-game-instance", authMiddleware, asyncHandler(userController.getUserGameInstances));
router.get("/get-subscription", asyncHandler(userController.getAllSubscriptionPlans));
