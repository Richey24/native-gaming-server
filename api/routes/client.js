...
router.post("/google-register", asyncHandler(clientController.socialRegisterClient));
router.post("/game-instance-play", clientAuthMiddleware, asyncHandler(clientController.playGame));
